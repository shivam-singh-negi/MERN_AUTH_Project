...
function Navbar() {
  return (
    <>
        ...
        <nav
          aria-label="Global"
          class="mx-auto max-w-container px-4 sm:px-6 lg:px-8 relative z-50 w-full flex-none text-sm font-semibold leading-6 text-slate-900"
        >
          <div class="relative flex items-center py-[2.125rem] justify-between">
            <Link class="flex-none text-slate-900" to="/">
              <span class="sr-only">Happy Me</span>
              <svg
                class="h-6 w-auto"
                aria-hidden="true"
                viewBox="0 0 160 24"
            ...
            <div class="ml-auto hidden sm:flex lg:items-center">
              <Link to="/">Home</Link>
              <Link class="ml-8" to="/about">
                About
              </Link>
              <Link class="ml-8" href="/profile">
                Profile
              </Link>
            </div>
            ...
            <button
              type="button"
              class="-my-1 -mr-1 ml-6 flex h-8 w-8 items-center justify-center sm:hidden"
            >
            ...
            <div class="hidden sm:ml-8 sm:flex lg:items-center lg:border-l lg:border-slate-900/15 lg:pl-8">
